...
from src.systematic_trading_infra.backtester import backtester_orchestrator
import sys
import logging
...
obj_to_push = {"s3://systematic-trading-infra-storage/paper_trading/signals_values.parquet":res["signals_values"],
               "s3://systematic-trading-infra-storage/paper_trading/signals.parquet":res["signals"],
               "s3://systematic-trading-infra-storage/paper_trading/bench_signals_values.parquet":res["bench_signals_values"],
               "s3://systematic-trading-infra-storage/paper_trading/bench_signals.parquet":res["bench_signals"],
               "s3://systematic-trading-infra-storage/paper_trading/weights.parquet":res["weights"],
               "s3://systematic-trading-infra-storage/paper_trading/bench_weights.parquet":res["bench_weights"]
               }
s3Utils.push_objects_to_s3_parquet(objects_dct=obj_to_push)

# 3/ create/initialize the orders df
orders_mngt = OrdersManagement(
    orders_s3_path="s3://systematic-trading-infra-storage/paper_trading/orders.parquet",
    strat_weights_s3_path="s3://systematic-trading-infra-storage/paper_trading/weights.parquet",
    ...
    wrds_universe_s3_path="s3://systematic-trading-infra-storage/data/wrds_universe.parquet",
